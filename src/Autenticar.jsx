...
const Autenticar = () => {
  return (
    <div className="bg-gradient-to-b from-[#000000] relative to-[#9F4AFF] min-h-screen">
      <section className="relative pt-24 pb-10 sm:pt-32 sm:pb-16 lg:pb-24 min-h-screen">
        <div className="absolute bottom-0 z-10 hidden lg:flex">
          <img className="hidden w-full lg:block" src={imagen} alt="" />
        </div>

        <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8 relative z-20">
          <div className="max-w-xl mx-auto text-center">
            <h1 className="text-4xl font-bold sm:text-6xl">
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-violet-600 to-white">
                Renueva tu armario y sé sostenible
              </span>
            </h1>
            <p className="mt-5 text-base text-white sm:text-xl">
              ¡Explora, descubre y reinventa tu estilo! Encuentra piezas únicas en nuestra tienda online de ropa de segunda mano.
            </p>
            <div className="botones flex flex-col sm:flex-row sm:justify-center sm:items-center min-w-screen">
              <a
                href="/login"
                title=""
            ...
            <div className="grid grid-cols-1 px-20 mt-12 text-left gap-x-12 gap-y-8 sm:grid-cols-3 sm:px-0">
              <div className="flex items-center">
                ...
                <p className="ml-3 text-sm text-white">Más de 10.000 usuarios</p>
              </div>
              ...
              <div className="flex items-center">
                ...
                <p className="ml-3 text-sm text-white">Ropa verificada por expertos</p>
              </div>
              ...
              <div className="flex items-center">
                ...
                <p className="ml-3 text-sm text-white">Pago seguro</p>
              </div>
            </div>
          </div>
        </div>
